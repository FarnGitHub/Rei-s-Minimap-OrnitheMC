...
public class GuiOptionScreen extends Screen implements GuiScreenInterface {
	...
	private static final String[] TITLE_STRING = new String[]{"Rei's Minimap Ornithe " + ReiMinimap.version, "Minimap Options", "SurfaceMap Options", "Entities Radar Options", "Marker Options", "About Rei's Minimap"};
	private int page;
	...
	protected void buttonClicked(ButtonWidget button) {
		if(button instanceof GuiOptionButton) {
			GuiOptionButton optionWidget = (GuiOptionButton)button;
