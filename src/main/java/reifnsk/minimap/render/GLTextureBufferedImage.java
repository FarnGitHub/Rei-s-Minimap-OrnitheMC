...
public class GLTextureBufferedImage extends BufferedImage {
	private static final ByteBuffer buffer = GlAllocationUtils.allocateByteBuffer(4194304);
	private static final IntBuffer singleIntBuffer = GlAllocationUtils.allocateIntBuffer(1);
	...
	public int register() {
		...
		try {
			...
			GlAllocationUtils.generateTextureNames(singleIntBuffer);
